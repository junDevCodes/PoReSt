...
- jest 기준선은 태스크 완료 시마다 갱신 (현재: 64 suites, 413 tests)
...
- [x] Test-M8-05: AI 이력서 초안 API 입력 검증
- [x] Test-M8-06: NoteEdge CANDIDATE 자동 생성

### M9 (T82~T83)

- [ ] Test-M9-01: PageView 기록 API + 집계 쿼리
- [x] Test-M9-02: 엔티티 연결 관계 CRUD + 포트폴리오 표시 (13개)

### M10 (T84~T86)

- [x] Test-M10-01: JobTracker Board + 상태 전이 + JD 매칭 파서 (22개)
- [x] Test-M10-02: Testimonial 공유 링크 → 작성 → 승인 플로우 (32개)
- [x] Test-M10-03: GrowthEvent 자동 수집 + 조회 (22개)
